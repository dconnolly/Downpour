...
match_patterns = {
    ...
    'video/tv': [
        ...
        # Show Name - s01e01 - Episode Title.avi
        re.compile(r'(?P<z>[\w -\.]+?)\W*s(?P<e>\d{1,2})\W?e(?P<s>\d{1,2})\W*(?P<n>[\w -\.]*\w).*\.(?P<x>\w+)$', re.IGNORECASE),
        # Show.Name.01x01.Episode.Title.avi
        # Show_Name_01x01_Episode_Title.avi
        # Show Name - 01x01 - Episode Title.avi
        re.compile(r'(?P<z>[\w -\.]+?)\W*(?P<e>\d{1,2})x(?P<s>\d{1,2})\W*(?P<n>[\w -\.]*\w).*\.(?P<x>\w+)$', re.IGNORECASE),
        # Show Name - s01e01.avi
        re.compile(r'(?P<z>[\w -\.]+?)\W*s(?P<e>\d{1,2})\W?e(?P<s>\d{1,2}).*\.(?P<x>\w+)$', re.IGNORECASE),
        # Show Name - 01x01.avi
        re.compile(r'(?P<z>[\w -\.]+?)\W*(?P<e>\d{1,2})x(?P<s>\d{1,2}).*\.(?P<x>\w+)$', re.IGNORECASE),
        # s01e01.avi
        re.compile(r's(?P<e>\d{1,2})\W?e(?P<s>\d{1,2}).*\.(?P<x>\w+)$', re.IGNORECASE),
        # 01x01.avi
        re.compile(r'(?P<e>\d{1,2})x(?P<s>\d{1,2}).*\.(?P<x>\w+)$', re.IGNORECASE),
    ],
    'video/other': [
    ],
    'image/photos': [
